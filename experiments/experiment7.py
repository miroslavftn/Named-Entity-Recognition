...
train_dataloader = create_data_loader(tr_inputs, tr_tags, tr_masks, batch_size=bs, mode='train')
valid_dataloader = create_data_loader(val_inputs, val_tags, val_masks, batch_size=bs, mode='val')
